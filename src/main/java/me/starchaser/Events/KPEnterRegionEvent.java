...
public class KPEnterRegionEvent extends KPRegionEvent implements Cancellable {
    private boolean cancelled;
    private boolean cancellable;
    private KPBlock kpBlock;
    public KPEnterRegionEvent(IWrappedRegion region, Player player, WGRegionEventsListener.PlayerMovementWay movement, PlayerEvent parent, KPBlock kpBlock, KPRegionInfo info)
    {
